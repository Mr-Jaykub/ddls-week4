...
<section class="slide">
  ...
  <p class="lead">A cancer researcher has an AI-predicted 3D model of p53 &mdash; a protein that
  goes wrong in roughly half of all human tumours. She wants to hand a chemist a list of exact
  positions to design a drug against.</p>
  <p class="lead" style="margin-top:1.3rem"><strong>Her question:</strong> which positions in the
  folded part are too unreliable to build on?</p>
</section>
...
<section class="slide">
  ...
  <div class="two">
    <div>
      <h3>pLDDT &mdash; one per position</h3>
      <p>&ldquo;Is <em>this</em> bit in the right place?&rdquo;<br>
      Scored 0&ndash;100. Higher is better.</p>
    </div>
    <div>
      <h3>PAE &mdash; one per pair</h3>
      <p>&ldquo;Are <em>these two</em> bits in the right place relative to each other?&rdquo;</p>
    </div>
  </div>
  <ul style="margin-top:2.2rem">
    <li>Her question is about single positions &mdash; so <strong>pLDDT</strong> is the right one.</li>
    ...
    <li>Checked it is really her protein: sequence matches exactly, <strong>393 positions</strong>,
    no mutations.</li>
  </ul>
</section>
...
<section class="slide">
  ...
  <div class="two">
    <div><h3>Pi &mdash; the analyst</h3>
      <p>Wrote the spec, the analysis script, the results file and the viewer. Found a
      modification noted at position 183 on its own &mdash; and correctly refused to claim it
      explained anything.</p></div>
...
<section class="slide">
  ...
  <ul style="margin-top:0">
    <li class="warn">A confidence score says nothing about chemical <strong>modifications</strong>,
    binding <strong>partners</strong>, or the fact that real p53 works as a <strong>group of
    four</strong> &mdash; this model is a single copy.</li>
